...
struct MBR {
  ...
  int32_t BPB_HiddSec;      // 0x1C - 0x1F
  int32_t BPB_TotSec32;     // 0x20 - 0x23

  // extended BPB structure for FAT32
  int32_t BPB_FATSz32;      // 0x24 - 0x27
  int16_t BPB_ExtFlags;     // 0x28 - 0x29
  int16_t BPB_FSVer;        // 0x2A - 0x2B
  int32_t BPB_RootClus;     // 0x2C - 0x2F
  int16_t BPB_FSInfo;       // 0x30 - 0x31
  int16_t BPB_BkBootSec;    // 0x32 - 0x33
  char    BPB_Reserved[12]; // 0x34 - 0x3F
  int8_t  BS_DrvNum;        // 0x40
  int8_t  BS_Reserved1;     // 0x41
  int8_t  BS_BootSig;       // 0x42
  int32_t BS_VolID;         // 0x43 - 0x46
  char    BS_VolLab[11];    // 0x47 - 0x51
  char    BS_FilSysTyle[8]; // 0x52 - 0x59
  char    EMPTY[420];       // 0x5A
  int8_t SignatureWord;     // 0x1FE
